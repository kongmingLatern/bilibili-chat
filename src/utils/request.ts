...
export const corsGetResp = url =>
	getResp(`https://api.codetabs.com/v1/proxy/?quest=${url}`)

export const corsGet = url =>
	get(`https://api.codetabs.com/v1/proxy/?quest=${url}`)
...
export const autoGet = url =>
	canCORS ? get(url) : corsGet(url)

export const autoGetResp = url =>
	canCORS ? getResp(url) : corsGetResp(url)
